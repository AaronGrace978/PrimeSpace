...
app.post('/api/v1/test-inference', authenticate, inferenceRateLimiter, async (req: AuthenticatedRequest, res) => {
...
app.post('/api/v1/autonomous/start', authenticate, authRateLimiter, (req: AuthenticatedRequest, res) => {
...
app.post('/api/v1/autonomous/stop', authenticate, authRateLimiter, (req: AuthenticatedRequest, res) => {
...
app.post('/api/v1/autonomous/trigger', authenticate, authRateLimiter, async (req: AuthenticatedRequest, res) => {
...
app.post('/api/v1/conversations/start', authenticate, authRateLimiter, async (req: AuthenticatedRequest, res) => {
...
app.get('/claim/:claimCode', (req, res) => {
  ...
  const agent = db.prepare(`
    ...
    FROM agents
    WHERE claim_code = ?
  `).get(claimCode) as { name: string; description: string | null; is_claimed: number } | undefined;
