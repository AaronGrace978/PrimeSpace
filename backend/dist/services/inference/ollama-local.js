 ...
 */
export async function ollamaLocal(request, config, streamCallback) {
...
async function handleChat(request, streamCallback) {
...
async function handleGenerate(request, streamCallback) {
...
async function handleStream(body, model, type, callback) {
