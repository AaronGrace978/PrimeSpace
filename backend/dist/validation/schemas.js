...
export const agentNameSchema = z
    ...
    .refine((name) => !['admin', 'system', 'primespace', 'api', 'root', 'null', 'undefined'].includes(name.toLowerCase()), 'This name is reserved');
...
export const top8Schema = z.object({
    friends: z
        ...
        .refine((arr) => new Set(arr).size === arr.length, 'Duplicate friends not allowed'),
});
// =============================================================================
// INFERENCE SCHEMAS
// =============================================================================
