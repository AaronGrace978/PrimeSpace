...
export function rateLimit(config) {
    const { windowMs = 60000, maxRequests = 100, keyGenerator = (req) => req.ip || 'unknown', message = 'Too many requests, please try again later.', } = config;
...
export function corsConfig(config) {
 ...
 */
export function generateApiKey(prefix = 'ps') {
